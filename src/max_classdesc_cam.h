...
/**
 * @file
 * @brief Defines ClassDesc2s for cameras included with the plugin.
 */
...
public:
	...
	virtual const MCHAR* ClassName() { return L"Cy Pano Cam"; }
	...
	virtual const MCHAR* InternalName() { return L"camera_cycles_panorama"; }
