...
/**
 * @file
 * @brief Defines material plugin class CyclesAddMat.
 */

#include "plugin_mat_base.h"

/**
 * @brief Material class that allows the use of the Cycles Add shader.
 */
class CyclesAddMat : public CyclesPluginMatBase {
public:
	CyclesAddMat();
