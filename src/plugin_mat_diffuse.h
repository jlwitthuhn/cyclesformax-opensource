...
/**
 * @file
 * @brief Defines material plugin class CyclesDiffuseMat.
 */

#include "plugin_mat_base.h"

 /**
  * @brief Material class that allows the use of the Cycles Diffuse shader.
  */
class CyclesDiffuseMat : public CyclesPluginMatBase {
public:
	CyclesDiffuseMat();

	// Paramblock access
	Color GetDiffuseColor(TimeValue t, Interval& iv);
	Texmap* GetDiffuseColorTexmap();
