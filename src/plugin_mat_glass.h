...
/**
 * @file
 * @brief Defines material plugin class CyclesGlassMat.
 */

#include "plugin_mat_base.h"

 /**
  * @brief Material class that allows the use of the Cycles Glass shader.
  */
class CyclesGlassMat : public CyclesPluginMatBase {
public:
	CyclesGlassMat();

	// Paramblock access
	GlassDistribution GetDistribution(TimeValue t, Interval& iv);
	Color GetGlassColor(TimeValue t, Interval& iv);
	Texmap* GetGlassColorTexmap();
