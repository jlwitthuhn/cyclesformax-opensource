...
/**
 * @file
 * @brief Defines material plugin class CyclesHoldoutMat.
 */

#include "plugin_mat_base.h"

 /**
  * @brief Material class that allows the use of the Cycles Holdout shader.
  */
class CyclesHoldoutMat : public CyclesPluginMatBase {
public:
	CyclesHoldoutMat();
