...
/**
* @file
* @brief Defines material plugin class CyclesShaderMat.
*/
...
/**
* @brief Material class that allows the configuration of shader-level parameters.
*/
class CyclesShaderMat : public CyclesPluginMatBase {
public:
	CyclesShaderMat();
