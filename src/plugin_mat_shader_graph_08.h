...
/**
 * @file
 * @brief Defines material plugin class CyclesShaderGraphMat08.
 */

#include "plugin_mat_shader_graph.h"

/**
 * @brief Material class that allows the use of a cycles shader graph with 8 texture slots.
 */
class CyclesShaderGraphMat08 : public CyclesShaderGraphMatBase, public ShaderGraph08Mixin {
public:
	CyclesShaderGraphMat08();
