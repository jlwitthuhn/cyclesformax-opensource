...
/**
 * @file
 * @brief Defines material plugin class CyclesShaderGraphMat32.
 */

#include "plugin_mat_shader_graph.h"

 /**
  * @brief Material class that allows the use of a cycles shader graph with 32 texture slots.
  */
class CyclesShaderGraphMat32 : public CyclesShaderGraphMatBase, public ShaderGraph32Mixin {
public:
	CyclesShaderGraphMat32();
