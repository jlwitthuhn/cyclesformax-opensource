...
/**
 * @file
 * @brief Defines material plugin class CyclesTranslucentMat.
 */

#include "plugin_mat_base.h"

 /**
  * @brief Material class that allows the use of the Cycles Translucent shader.
  */
class CyclesTranslucentMat : public CyclesPluginMatBase {
public:
	CyclesTranslucentMat();
