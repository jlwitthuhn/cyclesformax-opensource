...
/**
 * @file
 * @brief Defines material plugin class CyclesTransparentMat.
 */

#include "plugin_mat_base.h"

 /**
  * @brief Material class that allows the use of the Cycles Transparent shader.
  */
class CyclesTransparentMat : public CyclesPluginMatBase {
public:
	CyclesTransparentMat();

	// Paramblock access
	Color GetTransColor(TimeValue t, Interval& iv);
	Texmap* GetTransColorTexmap();
