...
/**
 * @file
 * @brief Defines material plugin class CyclesVelvetMat.
 */

#include "plugin_mat_base.h"

/**
 * @brief Material class that allows the use of the Cycles Velvet shader.
 */
class CyclesVelvetMat : public CyclesPluginMatBase {
public:
	CyclesVelvetMat();
	...
	float GetSigma(TimeValue t, Interval& iv);
	Texmap* GetSigmaTexmap();
