...
/**
 * @file
 * @brief Defines material plugin class CyclesVolAbsorptionMat.
 */

#include "plugin_mat_base.h"

 /**
  * @brief Material class that allows the use of the Cycles Volume Absorption shader.
  */
class CyclesVolAbsorptionMat : public CyclesPluginMatBase {
public:
	CyclesVolAbsorptionMat();
