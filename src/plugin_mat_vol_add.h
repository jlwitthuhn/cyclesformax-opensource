...
/**
 * @file
 * @brief Defines material plugin class CyclesVolAddMat.
 */

#include "plugin_mat_base.h"

 /**
  * @brief Material class that allows the use of the Cycles Volume Add shader.
  */
class CyclesVolAddMat : public CyclesPluginMatBase {
public:
	CyclesVolAddMat();
