...
/**
 * @file
 * @brief Defines material plugin class CyclesVolMixMat.
 */

#include "plugin_mat_base.h"

 /**
  * @brief Material class that allows the use of the Cycles Volume Mix shader.
  */
class CyclesVolMixMat : public CyclesPluginMatBase {
public:
	CyclesVolMixMat();
