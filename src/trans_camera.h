...
/**
 * @file
 * @brief Defines the translator class CyclesCameraTranslator.
 */
...
class CyclesCameraTranslator : public MaxSDK::RenderingAPI::Translator, protected MaxSDK::RenderingAPI::ICameraContainer::IChangeNotifier
{
public:
	typedef MaxSDK::RenderingAPI::GenericTranslatorKey_Empty<CyclesCameraTranslator> TranslatorKey;

	CyclesCameraTranslator(const TranslatorKey& key, MaxSDK::RenderingAPI::TranslatorGraphNode& translator_graph_node);
	~CyclesCameraTranslator();

	bool GetCameraParams(CyclesCameraParams& camera_params) const;
