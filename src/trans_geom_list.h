...
/**
 * @file
 * @brief Defines the translator class CyclesGeometryListTranslator.
 */
...
class CyclesGeometryListTranslator : public MaxSDK::RenderingAPI::Translator, protected MaxSDK::RenderingAPI::ISceneContainer::IChangeNotifier
{
public:
	typedef MaxSDK::RenderingAPI::GenericTranslatorKey_Empty<CyclesGeometryListTranslator> TranslatorKey;

	bool GetSceneGeometry(CyclesSceneGeometryList& scene_geometry) const;

	CyclesGeometryListTranslator(const TranslatorKey& key, MaxSDK::RenderingAPI::TranslatorGraphNode& translator_graph_node);
	~CyclesGeometryListTranslator();
