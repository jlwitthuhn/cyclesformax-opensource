...
/**
 * @file
 * @brief Defines the translator class CyclesLightListTranslator.
 */
...
class CyclesLightListTranslator : public MaxSDK::RenderingAPI::Translator, protected MaxSDK::RenderingAPI::ISceneContainer::IChangeNotifier
{
public:
	typedef MaxSDK::RenderingAPI::GenericTranslatorKey_Empty<CyclesLightListTranslator> TranslatorKey;

	bool GetSceneLights(CyclesSceneLightList& scene_lights) const;

	CyclesLightListTranslator(const TranslatorKey& key, MaxSDK::RenderingAPI::TranslatorGraphNode& translator_graph_node);
	~CyclesLightListTranslator();
