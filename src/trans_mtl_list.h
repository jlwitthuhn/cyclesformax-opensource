...
/**
 * @file
 * @brief Defines the translator class CyclesMaterialListTranslator.
 */
...
class CyclesMaterialListTranslator : public MaxSDK::RenderingAPI::Translator, protected MaxSDK::RenderingAPI::ISceneContainer::IChangeNotifier
{
public:
	typedef MaxSDK::RenderingAPI::GenericTranslatorKey_Empty<CyclesMaterialListTranslator> TranslatorKey;

	CyclesMaterialListTranslator(const TranslatorKey& key, MaxSDK::RenderingAPI::TranslatorGraphNode& translator_graph_node);
	~CyclesMaterialListTranslator();

	bool GetMaterialProperties(MaterialProperties& mtl_properties) const;
