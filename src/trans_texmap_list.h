...
/**
 * @file
 * @brief Defines the translator class CyclesTexmapListTranslator.
 */
...
class CyclesTexmapListTranslator : public MaxSDK::RenderingAPI::Translator
{
public:
	typedef MaxSDK::RenderingAPI::GenericTranslatorKey_Empty<CyclesTexmapListTranslator> TranslatorKey;

	CyclesTexmapListTranslator(const TranslatorKey& key, MaxSDK::RenderingAPI::TranslatorGraphNode& translator_graph_node);
	~CyclesTexmapListTranslator();

	bool GetTexmapUpdateTimes(TexmapUpdateTimes& update_ticks) const;
